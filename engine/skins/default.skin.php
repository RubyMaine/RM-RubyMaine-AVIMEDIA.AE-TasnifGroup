...
<head>
	...
	<meta charset="utf-8">
	<title> AVIMEDA GROUP - {$lang['skin_title']}</title>
...
//-->
	...
	<div class="navbar navbar-inverse bg-primary-700">
		<div class="navbar-header">
			<img src="engine/skins/images/tasnif.png" style="text-align: center;width: -1%;"> <a class="navbar-brand" href="?mod=main"> AVIMEDA </a>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4 style="font-weight: 600;"><i class="fa fa-buysellads" style="font-size: 40px;"></i>viMedia.ae - Админ панель </h4>
						</div>
...
$skin_footer = <<<HTML
					<div class="footer text-muted text-size-small">
						 <a href="https://avimedia.ae/" target="_blank"> AVIMEDA GROUP </a> Copyright 2022 &copy; Все права защищены.
					</div>
				</div>
			</div>
		</div>
...
<head>
	<link type="image/x-icon" href="engine/skins/images/favicon.ico" rel="shortcut icon">
	<meta charset="utf-8">
	<title>AVIMEDA GROUP - Login</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="HandheldFriendly" content="true">
	<meta name="format-detection" content="telephone=no">
	<meta name="viewport" content="user-scalable=no, initial-scale=1.0, maximum-scale=1.0, width=device-width"> 
...
<!--MAIN area-->
	...
	<div class="panel panel-default" style="margin-top: 70%;">

		<div class="panel-heading">
			<link type="image/x-icon" href="engine/skins/images/favicon.ico" rel="shortcut icon">
			<img src="engine/skins/images/favicon.png" style="text-align: center;width: 100%;">
		</div>
	...
	<div class="text-muted text-size-small text-center"> <a href="https://avimedia.ae/" target="_blank"> AVIMEDA GROUP </a> Copyright 2022 &copy; Все права защищены.</div>
