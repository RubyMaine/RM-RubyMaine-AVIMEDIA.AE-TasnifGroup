...
//-->
	...
	<div class="navbar navbar-inverse bg-primary-700">
		<div class="navbar-header">
			<a class="navbar-brand" href="?mod=main">Yoqubov.Uz</a>
...
$skin_footer = <<<HTML
					...
					&copy; Copyright by
	<a href="http://yoqubov.uz/" target="_blank">Yoqubov Shaxzod</a> All rights reserved.
					</div>
				</div>
			</div>
		</div>
...
<!--MAIN area-->
	...
	<div class="text-muted text-size-small text-center">&copy; Copyright by
	<a href="http://yoqubov.uz/" target="_blank">Yoqubov Shaxzod</a> All rights reserved.</div>
